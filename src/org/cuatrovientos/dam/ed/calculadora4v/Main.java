...
public class Main {
    ...
    /**
     * Método que realiza la multiplicación entre dos números proporcionados por el usuario.
     *
     * @param num1 Primer número.
     * @param num2 Segundo número.
     */
    ...
    /**
     * Método que realiza la división entre dos números proporcionados por el usuario.
     *
     * @param num1 Primer número.
     * @param num2 Segundo número.
     */
    private static void Division(double num1, double num2) {
        if (num2 != 0) {
            ...
            // FIXME: Añadir una validación más robusta en caso de que se produzca un error en la división
